...
speed_v4() {
    ...
    speed_test_v4 'https://speedtest.ny.buyvm.net/1000MB.test' 'BuyVM newyork'
    speed_test_v4 'http://199.231.208.6/1GB.test' 'BudgetVM chicago'
    speed_test_v4 'http://speedtest-dc04.enzu.com/1GB.test' 'BudgetVM dallas'
    speed_test_v4 'http://speedtest-dc05.enzu.com/1GB.test' 'BudgetVM miami'
    speed_test_v4 'http://lg-dal.hudsonvalleyhost.com/1000MB.test' 'HudsonValleyHost dallas'
    speed_test_v4 'http://lg-buff.hudsonvalleyhost.com/1000MB.test' 'HudsonValleyHost Buffalo'
    speed_test_v4 'http://lg-buff.hudsonvalleyhost.com/1000MB.test' 'HudsonValleyHost Buffalo'
    speed_test_v4 'http://lg-buff.hudsonvalleyhost.com/1000MB.test' 'HudsonValleyHost Buffalo'
    speed_test_v4 'http://lg-buff.hudsonvalleyhost.com/1000MB.test' 'HudsonValleyHost Buffalo'
