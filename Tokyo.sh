...
speed_v4() {
    speed_test_v4 'http://hnd-jp-ping.vultr.com/vultr.com.1000MB.bin' 'vultr tokyo'
    speed_test_v4 'http://sgp-ping.vultr.com/vultr.com.1000MB.bin' 'vultr singapore'
    speed_test_v4 'http://cachefly.cachefly.net/100mb.test' 'CacheFly'
}

speed_v6() {
    speed_test_v6 'http://hnd-jp-ping.vultr.com/vultr.com.1000MB.bin' 'vultr tokyo'
}
